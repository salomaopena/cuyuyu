...
class CuyuyuOptions {
  ...
  static CuyuyuOptions of(BuildContext context) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
    return scope.modelBindingState.currentModel;
  }

  static void update(BuildContext context, CuyuyuOptions newModel) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
...
class ApplyTextOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = CuyuyuOptions.of(context);
...
class ModelBinding extends StatefulWidget {
  ModelBinding({
    Key key,
    this.initialModel = const CuyuyuOptions(),
    this.child,
  })  : assert(initialModel != null),
        super(key: key);

  final CuyuyuOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  ...
  void handleTimeDilation(CuyuyuOptions newModel) {
  ...
  void updateModel(CuyuyuOptions newModel) {
